...
<?php echo $this->Form->create('BpnCertificate'); ?>
	<fieldset>
		<legend><?php echo __('Edit Bpn Certificate'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BpnCertificate.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BpnCertificate.id'))); ?></li>
