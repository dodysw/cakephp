...
<?php echo $this->Form->create('PropertiesBilling'); ?>
	<fieldset>
		<legend><?php echo __('Edit Properties Billing'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PropertiesBilling.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PropertiesBilling.id'))); ?></li>
